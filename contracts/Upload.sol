...
contract Upload {
    ...
    struct FileData {
        string plainUrl;    // For sender
        string encryptedHash; // For recipient
    }
    ...
    function add(address _user, string memory plainUrl, string memory encryptedHash) external {
        value[_user].push(FileData(plainUrl, encryptedHash));
    }
